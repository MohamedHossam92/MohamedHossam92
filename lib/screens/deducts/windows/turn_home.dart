...
class AluminumTurnHome extends StatelessWidget {
  static String id = 'AluminumTurnHome';
  final String cTWindowsProfiles;

  const AluminumTurnHome([this.cTWindowsProfiles = '']);
                ...
                return DOnWillPop(
                    ...
                    child: DeductHome(
                      ...
                      addNewBody: AddNewWindows(
                          list: turnCubit.windowsList, isSlide: false),
                      ...
                      detailsEdit: windowsEditDetails(false),
                      onTapAddNew: () {
